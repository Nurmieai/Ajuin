...
use App\Livewire\Student\AcademicService\ReviewPKL as StudentReviewPKL;
use App\Livewire\Teacher\ReviewPKL as TeacherReviewPKL;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['auth', 'role:student'])->group(function () {
        Route::prefix('student')->as('student.')->group(function () {
            ...
            Volt::route('/submission-letter-check', SubmissionLetterCheck::class)->name('submission-letter-check');
            Volt::route('/update/{id}', Update::class)->name('submission-edit');
            Route::get('/review-pkl', StudentReviewPKL::class)->name('review-pkl');
